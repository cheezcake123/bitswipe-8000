...
RISK_MODEL = os.getenv("RISK_MODEL") or default_agent_model("claude-haiku-4-5-20251001")
...
def _call_llm(system: str, user: str) -> str:
    ...
    return call_text_llm(
        system,
        user,
        model=model_for_provider(RISK_MODEL),
...
def run_risk_triad(
    ...
    if not has_llm_provider():
        return RiskTriadResult(enabled=False, rounds=0, error=provider_missing_message())
