...
from .llm_client import call_text_llm, default_agent_model, has_llm_provider, model_for_provider, provider_missing_message
from .prompts import (
    BULL_SYSTEM,
    BEAR_SYSTEM,
    BULL_USER_TEMPLATE,
...
DEBATE_MODEL = os.getenv("DEBATE_MODEL") or default_agent_model("claude-haiku-4-5-20251001")
...
def _call_llm(system: str, user: str) -> str:
    ...
    return call_text_llm(
        system,
        user,
        model=model_for_provider(DEBATE_MODEL),
...
def run_bull_bear_debate(
    ...
    if not has_llm_provider():
        return DebateResult(enabled=False, rounds=0, error=provider_missing_message())
